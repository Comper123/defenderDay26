...
export const Teacher = {
  ...
  image: "/nataly.png",
  description: `
  Наш классный руководитель - человек, который может одновременно проверять тетради, успокаивать родителей, решать школьные проблемы и находить потерянные сменки. Знает все наши секреты, но умеет держать язык за зубами (почти всегда).
  `,
  opinions: [
    {
      id: 1,
