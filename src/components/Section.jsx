    ...
    return (
        <section 
            ...
            className={`
                ...
                px-4 md:px-16 md:py-16 mx-auto
                w-[90%]
                bg-slate-900/90
            ...
            <div className="relative mx-auto z-10">
                {title && (
                    <div className="mb-8 md:mb-12">
                        <h2 className="relative inline-block text-start text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)] tracking-tight">{title}</h2>
                    </div>
                )}
