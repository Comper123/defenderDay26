     ...
     return (
        <div className={`${className} transition-all duration-300 overflow-hidden relative aspect-square cursor-pointer`}
            ...
            <div className="relative w-full h-full">
                ...
                } bg-black/40 absolute z-3 w-full h-full top-0 left-0 right-0 bottom-0 duration-300 sm:hidden md:block`}></span>
            </div>

            {/* Информация */}
            <div className={`${isHovered ? '-translate-y-[100%]' : 'translate-y-0'} duration-300 py-3 px-5 sm:hidden md:block`}>
